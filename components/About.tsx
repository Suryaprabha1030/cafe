...
const About = () => {
  return (
    <div className="relative w-full   bg-primary gap-10   flex flex-col justify-start ">
      {/* <Navbar/> */}
      <section className="relative w-1/2 mt-20 sm:w-full lg:w-4/5 container mx-auto  flex flex-col sm:flex-row items-center justify-center border-4 border-sub bg-sub rounded-lg ">
        <h1 className=" absolute z-40 -top-9 sm:-top-8  lg:-top-12 right-2 text-logo text-5xl lg:text-7xl font-logo font-bold">
          About Us
        </h1>
        <Image
          className="w-abt lg:w-abt2 object-cover border-2 border-secondary w-[15rem]"
          src="/wp2.jpg"
          alt="cofee"
          width="50"
          height="50"
        />
        <p className="w-auto md:w-4/5  px-4 text-card text-justify text-md lg:text-lg font-default mt-5 mb-5 sm:mb-0 sm:mt-0 ">
